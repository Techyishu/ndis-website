...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            ...
            <div className="w-24 h-1 bg-emerald-600 mx-auto mb-6 sm:mb-8"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="group bg-gray-50 rounded-xl p-6 sm:p-8 shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-emerald-300 transform hover:-translate-y-2 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.1}s`, opacity: 0 }}
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-emerald-100 rounded-full flex items-center justify-center group-hover:bg-emerald-600 group-hover:scale-110 transition-all duration-300">
                  {item.icon === "nurse" && (
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-600 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 text-center group-hover:text-emerald-600 transition-colors duration-300">{item.title}</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed text-center">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            ...
            <div className="text-left max-w-2xl mx-auto space-y-2 sm:space-y-3 mb-6 sm:mb-8">
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">Help with Daily Life (like self-care and household tasks)</p>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">Support Coordination (we help you manage your plan)</p>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">Community & Social Support (getting out and about)</p>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">Transport (getting to appointments or activities)</p>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">Therapeutic Supports (accessing therapists)</p>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 mr-2 sm:mr-3 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm sm:text-base md:text-lg text-gray-700">And much more...</p>
              </div>
            </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-scale-in">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-emerald-50 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={index}
                className="group bg-white rounded-xl p-6 sm:p-8 shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-emerald-300 transform hover:-translate-y-2 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.1}s`, opacity: 0 }}
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-emerald-100 rounded-full flex items-center justify-center group-hover:bg-emerald-600 group-hover:scale-110 transition-all duration-300">
                  {feature.icon === "clock" && (
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 text-center group-hover:text-emerald-600 transition-colors duration-300">{feature.title}</h3>
            ...
            {[
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 group-hover:text-emerald-600 transition-colors duration-300">{service.title}</h3>
                  <p className="text-sm sm:text-base text-emerald-600 font-semibold group-hover:text-emerald-700 transition-colors duration-300 flex items-center">
                    Learn More
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={index}
                className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl hover:bg-emerald-50 transition-all duration-300 border-2 border-transparent hover:border-emerald-200 transform hover:-translate-y-1 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.1}s`, opacity: 0 }}
              >
          ...
          <div className="text-center mt-8 sm:mt-12 animate-fade-in-up animation-delay-400">
            <Link
              href="/about"
              className="inline-block text-emerald-600 font-semibold hover:text-emerald-700 text-base sm:text-lg transition-all duration-300 hover:translate-x-2"
            >
              MORE ABOUT US →
            </Link>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <Link
                href="/contact"
                className="inline-block bg-emerald-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm sm:text-base"
              >
                GET STARTED
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-fade-in-up animation-delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <span className="inline-block bg-gray-100 px-4 py-2 sm:px-6 sm:py-3 rounded-lg text-gray-700 font-semibold text-center hover:bg-emerald-100 hover:text-emerald-700 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-scale-in">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-emerald-50">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <Link
                href="/contact"
                className="inline-block bg-emerald-700 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-emerald-800 transition-all duration-300 border-2 border-white shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm sm:text-base"
              >
                GET STARTED
              </Link>
            </div>
